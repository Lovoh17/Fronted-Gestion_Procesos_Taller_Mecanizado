<template>
  ...
  <div class="transactions-table-container" v-if="!loading">
    ...
    <div v-if="viewMode === 'table'" class="table-responsive">
      <vue-good-table ref="vueGoodTable" :columns="tableColumns" :rows="filteredTransacciones" max-height="60vh"
        :fixedHeader="true" :search-options="{
          enabled: true,
        ...
        <template #table-row="props">
          ...
          <span v-else-if="props.column.field === 'actions'">
            <div class="action-buttons">
              <va-button size="small" preset="plain" color="info" @click="verDetalles(props.row)" title="Ver detalles"
                icon="eye" class="mr-1"></va-button>
              ...
              <va-button size="small" preset="plain" color="danger" @click="eliminarTransaccion(props.row.id)"
                :disabled="loadingDelete === props.row.id" title="Eliminar" icon="delete"></va-button>
            </div>
          </span>
